...
import org.team100.frc2026.ShooterTable.Row;
...
public class Targeter {
    ...
    public Targeter(Supplier<Translation2d> position) {
        ...
        m_score = new ShooterTable(
                List.of(
                        new Row(0, 5, 1, 0.1),
                        new Row(1.49, 5, 0.90, 0.1),
                        new Row(2.07, 6, 0.78, 0.2),
                        new Row(2.50, 7, 0.66, 0.3),
                        new Row(3.02, 8, 0.59, 0.4),
                        new Row(3.59, 9, 0.53, 0.5),
                        new Row(4.10, 10, 0.48, 0.6),
                        new Row(4.50, 11, 0.44, 0.7),
                        new Row(16, 12, 0.5, 2)));
        m_lob = new ShooterTable(
                List.of(
                        new Row(0.0, 4, 0.3, 0.3),
                        new Row(1.0, 5, 0.3, 0.3),
                        new Row(2.0, 6, 0.3, 0.3),
                        new Row(3.0, 7, 0.3, 0.3),
                        new Row(4.0, 8, 0.3, 0.3),
                        new Row(5.0, 9, 0.3, 0.3),
                        new Row(6.0, 10, 0.3, 0.3),
                        new Row(16, 12, 0.5, 2)));
    }
